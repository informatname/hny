...
function Start() {
   ...
   B2.Start();
   B2 = new Ball(document.getElementById('move_pic5'), Videos);
   B2.Start();
   B2 = new Ball(document.getElementById('move_pic6'), Videos);
   B2.Start();
   B2 = new Ball(document.getElementById('move_pic7'), Videos);
   B2.Start();
   B2 = new Ball(document.getElementById('move_pic8'), Videos);
   B2.Start();
}
